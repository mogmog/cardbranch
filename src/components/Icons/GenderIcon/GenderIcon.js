...
export default ({gender, width = 60, selected}) => {
  ...
  const Man = (
    ...
    >
      <g id="Icons-FUNNEL-ATTRACTION" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" >
        <g id="ic-man" fill="#999999">
          <g id="Group-12">
  ...
  const Woman = (<svg className={selected && styles.female} viewBox="0 0 2 31" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <defs></defs>
    <g id="Icons-FUNNEL-ATTRACTION" stroke="none" strokeWidth="1" fill="black" fillRule="evenodd" >
      <g id="ic-woman" fill="#999999">
        <g id="Group-12">
          <path
