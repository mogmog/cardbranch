...
class NumericDistribution extends Component {
  ...
  render() {
    return (
      <div ref="plot" style={{height: '250px'}}>
      </div>
    );
  }
  ...
  componentDidUpdate() {
    ...
    const width  = 180;///.ReactDOM.findDOMNode(this.refs.plot).offsetWidth - margin.left - margin.right;
    const height = 180;//ReactDOM.findDOMNode(this.refs.plot).offsetHeight - margin.top - margin.bottom;
